...
int main(const int argc, char** argv) {
    ...
    const auto [jobs, workPerJob, frames, verify] = parse(argc, argv);
    ...
    for (u32 f = 0; f < frames; ++f) {
        ...
        JobCounter counter;
        const u32 work = workPerJob;
        js.runN(jobs, [work](const u32 i) {
